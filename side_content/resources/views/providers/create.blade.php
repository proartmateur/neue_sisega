...
@section('breadcrumb')
    <h3 class="m-subheader__title m-subheader__title--separator">Crear proveedor</h3>
...
@section('content')
    <div class="m-portlet">
        ...
        {!! Form::open(['route'=>'providers.store', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'m-form m-form--fit m-form--label-align-right']) !!}
