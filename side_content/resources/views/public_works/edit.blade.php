...
@section('breadcrumb')
    ...
    <h3 class="m-subheader__title m-subheader__title--separator">Editar obra</h3>
...
@section('content')
    <div class="m-portlet">
        <div class="m-portlet__head">
            ...
            {!! Form::model($public_work,['route'=>['public-works.update',$public_work->id],'class'=>'form-horizontal', 'method'=>'PUT']) !!}
