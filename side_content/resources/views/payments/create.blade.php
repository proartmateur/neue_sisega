...
@section('content')
    <div class="m-portlet">
        ...
        {!! Form::open(['url' => '/providers/storePayment', 'method'=>'POST', 'enctype'=>'multipart/form-data', 'class'=>'m-form m-form--fit m-form--label-align-right', 'id'=>'payment_form', 'files'=>'true']) !!}
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-5">
                            <span  style="color: red" class="required-val">* </span>
                            {!! Form::label('Monto') !!}
                            {!! Form::number('amount', $debt, ['class' => 'form-control', 'step'=>'.01', 'max'=>$debt, 'id'=>'amount']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-5">
                            {!! Form::label('PDF') !!}
                            {!! Form::file('pdf', null, ['class' => 'form-control', 'accept'=>'application/pdf']) !!}
                        </div>
                    </div>
                </div>
        ...
        /*$('#payment_form').submit(function() {
            ...
            if(parseFloat(amount) === debt){
                swal({
                    ...
                    if (result.value) {
                        $("<input />").attr("type", "hidden").attr("name", "mail").attr("value", true).appendTo("#events_form");
                    }else {
                        $("<input />").attr("type", "hidden").attr("name", "mail").attr("value", false).appendTo("#events_form");
                    }
                });
            }else{
                $("<input />").attr("type", "hidden").attr("name", "mail").attr("value", false).appendTo("#events_form");
