...
<body style="overflow-x: hidden;">
    ...
    <div class="row">
        <div class="column">
            <div style="width: 100%; background-color:powderblue; height: 45px">
                <span style="font-size: 1.9rem; font-weight: 400;">{{$public_work->name}}</span>
            </div>
            <div style="width: 100%; background-color:green; height: 45px">
                <span style="font-size: 1.9rem; font-weight: 400;">{{$total}}</span>
            </div>
        </div>
        <div class="column">
            <div style="width: 100%; background-color:yellow; height: 90px">
